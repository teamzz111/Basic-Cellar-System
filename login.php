...
<body style="background: rgba(236, 236, 236, 0.788);">
    <div id="Login">
        ...
        <form class="formulario" id="formularioL"  accept-charset="utf-8" action="login.php?opt=1" method="post">
            ...
            if(isset($_GET['error']) && $_GET['error'] == 1){
                echo "<li style='background: red; padding: 3%;'>Autenticación fallida!</li>";
            }
            ?>          
